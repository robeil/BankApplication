...
public class Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		// get frank
		Contact contact= restTemplate.getForObject(serverUrl+"/{accountNumber}", Contact.class, "1263862");
		...
		// get john
		contact= restTemplate.getForObject(serverUrl+"/{accountNumber}", Contact.class, "4253892");
		System.out.println(contact);
